...
gcc -Wall -mwindows obj/main.o obj/menu.o obj/app.o obj/file.o obj/utils.o obj/crtable.o obj/sql.o obj/insdata.o lib/list.o lib/parser.o -o bin/sql-generator.exe