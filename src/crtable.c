...
{
    //range for ColumnControls (9,10 - 39,40)
    static int counter = 0;
    crTableMenuControls[9] = CreateWindowEx(WS_EX_CLIENTEDGE, "EDIT", COLUMNEDIT_MSG, STL_EDIT, 530, 75, 150, 24, hwnd, (HMENU)18, (HINSTANCE)GetWindowLongPtr(hwnd, GWLP_HINSTANCE), NULL);
    crTableMenuControls[10] = CreateWindow("COMBOBOX", COLUMNEDIT_MSG, STL_COMBO, 690, 75, 150, 100, hwnd, (HMENU)19, (HINSTANCE)GetWindowLongPtr(hwnd, GWLP_HINSTANCE), NULL);
    counter += 2;
}
